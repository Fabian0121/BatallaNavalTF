        ...
        <div class="col-lg-4 offset-2">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    @endfor
                    @if(isset($tableroBarco))
                        <label style="margin-top: 5%;" class="text-info">Cantidad de Barcos Por tumbar: <b id="tumbados"></b></label>
                    @endif
                </div>
    ...
    <script>
        $(document).ready(function (){
            ...
            function tirar(idBarco){
                ...
                var contador=isNaN(parseInt(window.name))?3:parseInt(window.name);
